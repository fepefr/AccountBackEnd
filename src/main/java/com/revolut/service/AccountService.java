...
public class AccountService {
	...
	public void transfer(Long acctNumFrom, Long AcctNumTo, Money amount, Money fee) throws AccountException {
		...
		if (accountFrom.equals(accountTo))
			throw new AccountException(Erro.ERROR_CODE_SAME_ACCT_TRANSF, Erro.ERROR_MSG_INVALID_TRANSFERECES_TO_THE_SAME_ACCOUNT);
	...
	private void withdraw(Account account, Money amount, Money fee) throws AccountException {
		...
		if (amount.isGreaterThan(balance)) {
			throw new AccountException(Erro.ERROR_CODE_INSUFFICIENT_FUNDS, Erro.ERROR_MSG_BALANCE_IS_NOT_SUFFICIENT + balance);
		}
	...
	public Account getAccount(Long acctNum) throws AccountException {
		...
		if (account == null) {
			throw new AccountException(Erro.ERROR_CODE_ACCOUNT_NOT_FOUND, MessageFormat.format(Erro.ERROR_MSG_ACCOUNT_NOT_FOUND, acctNum));
		}
		return account;
	}
